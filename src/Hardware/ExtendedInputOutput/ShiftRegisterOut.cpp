...
pin_t ShiftRegisterOut::green(pin_t id) { return 3 * id + greenBit + start; }
pin_t ShiftRegisterOut::red(pin_t id) { return 3 * id + redBit + start; }
pin_t ShiftRegisterOut::blue(pin_t id) { return 3 * id + blueBit + start; }
