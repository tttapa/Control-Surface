...
TEST_CASE("Insert some elements", "[INSERT]")
{
    ...
    Node *last = nullptr;
    Node a(1);
    LinkedList::append(&a, first, last);
    REQUIRE(first == &a);
    REQUIRE(last == &a);
    REQUIRE(a.previous == nullptr);
    REQUIRE(a.next == nullptr);
    Node b(2);
    LinkedList::append(&b, first, last);
    REQUIRE(first == &a);
    REQUIRE(last == &b);
    REQUIRE(a.previous == nullptr);
    REQUIRE(a.next == &b);
    ...
    Node c(3);
    LinkedList::append(&c, first, last);
    REQUIRE(first == &a);
    REQUIRE(last == &c);
    REQUIRE(a.previous == nullptr);
    REQUIRE(a.next == &b);
...
TEST_CASE("Insert some elements and read them back forwards", "[INSERT][LOOP]")
{
    Node *first = nullptr;
    Node *last = nullptr;
    Node *nodes[16];
    ...
    {
        nodes[i] = new Node(i);
        LinkedList::append(nodes[i], first, last);
    }
...
TEST_CASE("Insert some elements and read them back backwards", "[INSERT][LOOP]")
{
    Node *first = nullptr;
    Node *last = nullptr;
    Node *nodes[16];
...
TEST_CASE("Delete an element from the list", "[DELETE]")
{
    ...
    LinkedList::remove(nodes[2], first, last);
...
TEST_CASE("Delete the first element from the list", "[DELETE]")
{
    ...
    LinkedList::remove(nodes[0], first, last);
...
TEST_CASE("Delete the last element from the list", "[DELETE]")
{
    ...
    LinkedList::remove(nodes[4], first, last);
...
TEST_CASE("Move down an element","[MOVE]")
{
    ...
    LinkedList::moveDown(nodes[3], first, last);
...
TEST_CASE("Move down the first element","[MOVE]")
{
    ...
    LinkedList::moveDown(nodes[0], first, last);
...
TEST_CASE("Move down the second element","[MOVE]")
{
    ...
    LinkedList::moveDown(nodes[1], first, last);
    REQUIRE(first == nodes[1]);
...
TEST_CASE("Move down the last element","[MOVE]")
{
    ...
    LinkedList::moveDown(nodes[4], first, last);
    REQUIRE(last == nodes[3]);
...
TEST_CASE("Move down the only element","[MOVE]")
{
    ...
    Node *last = nullptr;
    Node node(0);
    LinkedList::append(&node, first, last);
    LinkedList::moveDown(&node, first, last);
    REQUIRE(first == &node);
    REQUIRE(last == &node);
