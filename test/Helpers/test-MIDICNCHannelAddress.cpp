...
TEST(MIDIAddress, equals) {
    {
        MIDIAddress m = {12, CHANNEL_10, 4};
        MIDIAddress n = {12, CHANNEL_10, 4};
        EXPECT_EQ(m, n);
        EXPECT_TRUE(m == n);
        EXPECT_FALSE(m != n);
    }
    {
        MIDIAddress m = {13, CHANNEL_10, 4};
        MIDIAddress n = {12, CHANNEL_10, 4};
        EXPECT_NE(m, n);
        EXPECT_TRUE(m != n);
        EXPECT_FALSE(m == n);
