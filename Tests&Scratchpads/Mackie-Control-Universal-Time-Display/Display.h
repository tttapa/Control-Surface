...
class MCU_TimeDisplay : public MIDI_Input_Element
{
public:
  MCU_TimeDisplay()
      : MIDI_Input_Element(0x40, 1, 0xA, 1)
  {
    ;
  }
  void refresh()
...
class MCU_AssignementDisplay : public MIDI_Input_Element
{
public:
  MCU_AssignementDisplay()
      : MIDI_Input_Element(0x4A, 1, 0x2, 1)
  {
    ;
  }
  void refresh()
