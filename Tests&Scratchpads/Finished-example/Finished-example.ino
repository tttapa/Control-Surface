...
CCRotaryEncoder enc = {{1, 0}, 0x2F, 1, speedMultiply, 4}; // Create a new instance of class 'RotaryEncoder' called enc, on pins 1 and 0, controller number 0x2F, on MIDI channel 1, at normal speed, using a normal encoder (4 pulses per click/step)
